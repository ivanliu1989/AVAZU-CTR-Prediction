...
lib_app = 'libLinear/pred/liblinear_pred_app'
lib_site = 'libLinear/pred/liblinear_pred_site'
pred_app = pd.read_csv(lib_app,index_col = False, header = None, delim_whitespace=True)
pred_site = pd.read_csv(lib_site,index_col = False, header = None, delim_whitespace=True)
